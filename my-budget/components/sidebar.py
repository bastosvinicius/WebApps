...
# ========= Layout ========= #
layout = dbc.Card([
    html.H1("Casa", className="text-primary"),
    html.Hr(),
        ...
        dbc.ModalBody([
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardImg(
                            src="/assets/img_hom.png", className='perfil_avatar', top=True),
                        dbc.CardBody([
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardImg(
                            src="/assets/img_fem2.png", top=True, className='perfil_avatar'),
                        dbc.CardBody([
                            html.H4("Perfil Mulher",
                                    className="card-title"),
                            html.P(
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardImg(
                            src="/assets/img_home.png", top=True, className='perfil_avatar'),
                        dbc.CardBody([
                            html.H4("Perfil Casa",
                                    className="card-title"),
                            html.P(
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        ...
                        dbc.Select(id="select_receita", options=[
                            {"label": i, "value": i} for i in cat_receita], value=cat_receita[0])
                    ], width=4)
                            ...
                            dbc.Row([
                                ...
                                dbc.Col([
                                    ...
                                    dbc.Checklist(
                                        ...
                                        options=[
                                            {"label": i, "value": i} for i in cat_receita],
                                        value=[],
                                        label_checked_style={
                                            "color": "red"},
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dbc.Select(id="select_despesa", options=[
                        {"label": i, "value": i} for i in cat_despesa])
                ], width=4)
            ], style={"margin-top": "25px"}),
...
def salve_form_despesa(n, valor, switches, descricao, date, txt, dict_despesas):
    ...
    if n and not (valor == "" or valor == None):
        ...
        df_despesas.loc[df_despesas.shape[0]] = [
            valor, recebido, fixo, date, descricao, txt]
